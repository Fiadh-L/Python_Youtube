...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.loginButton.setGeometry(QtCore.QRect(50, 140, 181, 31))
        font = QtGui.QFont()
        ...
        self.urlTextEdit = QtWidgets.QLineEdit(self.groupBox_2)
        self.urlTextEdit.setGeometry(QtCore.QRect(80, 20, 301, 31))
        self.urlTextEdit.setObjectName("urlTextEdit")
        self.previewButton = QtWidgets.QPushButton(self.groupBox_2)
        self.previewButton.setGeometry(QtCore.QRect(390, 20, 51, 31))
        self.previewButton.setObjectName("previewButton")
        self.pathTextEdit = QtWidgets.QLineEdit(self.groupBox_2)
        self.pathTextEdit.setGeometry(QtCore.QRect(80, 60, 301, 31))
        ...
        self.fileNavButton = QtWidgets.QPushButton(self.groupBox_2)
        self.fileNavButton.setGeometry(QtCore.QRect(390, 60, 51, 31))
        self.fileNavButton.setObjectName("fileNavButton")
        self.streamCombobox = QtWidgets.QComboBox(self.groupBox_2)
        self.streamCombobox.setGeometry(QtCore.QRect(80, 100, 361, 31))
        ...
        self.startButton.setGeometry(QtCore.QRect(290, 140, 71, 31))
        self.startButton.setObjectName("startButton")
        self.endButton = QtWidgets.QPushButton(self.groupBox_2)
        self.endButton.setGeometry(QtCore.QRect(366, 140, 75, 31))
